...
class RedisClient:
    ...
    def score_range(self, name, min, max):
        r = self.connection_client
        data = r.zrangebyscore(name, min, max, withscores=True)
        return data
...
if __name__ == '__main__':
    ...
    redis_client.lpush("test", 111, 2222)
    # res = redis_client.lpop("test")
